...
int tonepin = D3; // Set the Pin of the buzzer to the digital D3
     void setup ()
     {
     ...
     void loop ()
     {
       ...
       while (1)
       {
         ...
         for (k = 0; k <100; k ++) // output sound of another frequency
         {
           digitalWrite (tonepin, HIGH); // Sound
           delay (10); // delay 2ms
           digitalWrite (tonepin, LOW); // No sound
     ...
     //i < frequency
     //delay is duration/pitch kind of, longer delay means lower pitch
...
// };
// int length;
// int tonepin = D3; // Use interface 3
// void setup ()
// {
